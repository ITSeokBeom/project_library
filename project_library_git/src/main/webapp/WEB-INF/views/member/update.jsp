...
<article>
	...
	<h3><div style="border:2px solid lightgray; padding: 15px;">
		<span style="font-weight:bold;">회원정보수정</span>
		</div>
	</h3>
	<form id="join" action="/member/update" method="post" name="frm">
		<fieldset style="border:2px solid lightgray; padding: 15px;">
			
			<div class="join_content">
			
				<h3><label>아이디</label></h3>
				<input type="text" name="id" class="id" value="${ memberVo.id }" required readonly>
				<div id="msgIdDup"></div><br> 
				

				<h3><label>새 비밀번호</label></h3>
				<input type="password" name="passwd" class="pass pass1" required><br>
	
				<h3><label>새 비밀번호 확인 </label></h3>
				<input  type="password" name="newPasswdCheck" class="pass pass2" required>
				<div id="msgPass"></div> <br>
	
				<h3><label>이름</label></h3>
				<input type="text" name="name" class="value" id="name" value="${ memberVo.name }" required>
				
				<h3><label>E-Mail</label></h3>
				<input type="email" name="email" class="value" id="email" value="${ memberVo.email }" required>
				...
				<input type="tel" name="tel" class="value" value="${ memberVo.tel }" required  placeholder="(-)없이 입력해주세요."><br> 
				
				<h3><label>나이</label></h3>
				<input type="number" name="age" min="0" max="200" class="mobile" value="${ memberVo.age }" required><br>
	
				<h3><label>성별</label></h3>
<%-- 				<c:choose> --%>
<%-- 					<c:when test="${ memberVo.gender eq '남' }"> --%>
<!-- 						<input type="radio" name="gender" value="남" style="display: inline;" checked="checked"> 남성 -->
<!-- 						<input type="radio" name="gender" value="여" style="display: inline;"> 여성 <br> -->
<%-- 					</c:when> --%>
<%-- 					<c:otherwise> --%>
<!-- 						<input type="radio" name="gender" value="남" style="display: inline;"> 남성 -->
<!-- 						<input type="radio" name="gender" value="여" style="display: inline;" checked="checked"> 여성 <br> -->
<%-- 					</c:otherwise> --%>
<%-- 				</c:choose> --%>
				...
				<div class="clear"></div>
				<div id="join--buttons">
					<input class="btnJoin" type="submit" value="회원정보수정" class="submit"><br>
