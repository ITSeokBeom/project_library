...
<article>
	...
	<h3>
		...
		<span style="font-weight:bold;">비밀번호 찾기</span>
		</div>
	</h3>
	
	<fieldset style="border:2px solid lightgray; padding:150px ">
	<form action="/member/passwordSearchOk" method="post">
		...
		<ul class="login_innerBox">
			<li><label for="info_name">이메일</label><input type="text" id ="info_name" name="email" placeholder="이메일 주소를 입력하세요" ></li>
			<li><label for="info_tel">아이디</label><input type="text" id="info_tel" name="id" placeholder="아이디를 입력하세요" ></li>
			<li><label for="info_tel">이름</label><input type="text" id="info_tel" name="name" placeholder="이름을 입력하세요" ></li>
