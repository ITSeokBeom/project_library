	...
	<div id="bookContent_sy">
		...
		<div id="bookDetail_sy">
			...
			<div id="bookRight_sy">
				...
				<ul id="btn_sy">
					<li><button onclick="location.href='/use/borrow?memberId=${ id }&bookNum=${ bookVo.num }'">대출하기</button></li>
					<li><button onclick="location.href='/use/reserve?memberId=${ id }&bookNum=${ bookVo.num }'">예약하기</button></li>
					<li><button onclick="location.href='/use/recommend?memberId=${ id }&bookNum=${ bookVo.num }'">추천하기</button></li>
					<li><button onclick="location.href='/use/wish?memberId=${ id }&bookNum=${ bookVo.num }'"><i class="fas fa-star"></i> 찜하기</button></li>
				</ul>
			</div>
		</div>
